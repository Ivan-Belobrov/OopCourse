...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Вектора vector2: " + vector2);
        System.out.println("Вектора vector3: " + vector3);
        System.out.println();
        ...
        System.out.println("Компонент вектора vector3 с индексом 1: " + vector3.getComponent(1));
        vector3.setComponent(1, 6);
        System.out.println("Новый компонент вектора vector3 с индексом 1: " + vector3.getComponent(1));
        System.out.println();
        ...
        System.out.println("Скалярное произведение продукта vector2 и vector3: " + dotProduct);
